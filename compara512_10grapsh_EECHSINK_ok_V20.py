...
Programa: compara512_10grapsh_EECHSINK_ok_V20.py
...
SEED = 42  # Seed para reprodutibilidade consistente com outros programas
random.seed(SEED)
np.random.seed(SEED)
...
def main():
    ...
    # Gráfico 1: Potências por Cluster
    for num_clusters in cluster_sizes:
        ...
        ax.set_title(f"Gráfico 1: Potências por Cluster ({num_clusters} Clusters)")
        ax.set_xlabel("Cluster")
        ax.set_ylabel("Potência (W)")
        ax.legend()
        ax.xaxis.get_major_locator().set_params(integer=True)  # Forçar números inteiros no eixo X
    ...
    # Gráfico 2: Potência média de transmissão dos sensores para o Cluster Head
    ...
    ax.set_title("Gráfico 2: Potência Média de Sensores para CHs.")
    ...
    ax.set_title("Gráfico 3: Potência de CH-> Sink")
    ax.set_xlabel("Número de Clusters")
    ...
    ax.set_title("Gráfico 4: Correlação Potência CH-Sink / Potência Total (%)")
    ax.set_xlabel("Número de Clusters")
    ...
    ax.set_title("Gráfico 5: Consumo energético de Sensores por Clusters na RSSF")
    ax.set_xlabel("Número de Clusters")
    ...
    ax.set_title("Gráfico 6: Potência Total CH-Sink")
    ax.set_xlabel("Número de Clusters")
    ...
    ax.set_title("Gráfico 7: Eficiência energética de Clusters na RSSF")
    ax.set_xlabel("Número de Clusters")
    ax.set_ylabel("Eficiência Energética (%)")
    ...
    ax.set_title("Gráfico 8: Eficiência energética média dos Sensores -> Clusters Heads na RSSF (%)")
    ax.set_xlabel("Número de Clusters")
    ax.set_ylabel("Eficiência Energética (%)")
    ...
    ax.set_title("Gráfico 9: Eficiência energética dos Sensores -> Clusters Heads na RSSF (%)")
    ax.set_xlabel("Número de Clusters")
    ax.set_ylabel("Eficiência Energética (%)")
